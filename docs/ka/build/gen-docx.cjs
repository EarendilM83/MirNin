...
kids.push(new Paragraph({ alignment: AlignmentType.LEFT, spacing: { before: 200, after: 0 },
  children: [ new TextRun({ text: '10X LMS', bold: true, size: 26, color: ACCENT, font: FONT }) ] }));
...
const doc = new Document({
  ...
  sections: [ {
    ...
    headers: { default: new Header({ children: [ new Paragraph({
      ...
      children: [ new TextRun({ text: '10X LMS · სისტემის აღწერა', size: 15, color: MUT, font: FONT }) ] }) ] }) },
